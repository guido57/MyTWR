...
#define DEFAULT_UHF_FREQ        (410000000UL)
#define DEFAULT_VHF_FREQ        (150000000UL)

#define __UHF_MIN_FREQ          (400000000UL)
#define __UHF_MAX_FREQ          (480000000UL)
#define __UHF_FREQ_RANGE        (80)
#define __350_MIN_FREQ          (320000000UL)
#define __350_MAX_FREQ          (400000000UL)
#define __350_FREQ_RANGE        (80)
#define __VHF_MIN_FREQ          (134000000UL)
#define __VHF_MAX_FREQ          (174000000UL)
...
public:
    ...
    bool begin(Stream &serial, enum RadioType type);
    ...
    void setRxCXCSS(uint32_t val);

    void setTxCXCSS(uint32_t val);


    void setSquelchLevel(uint8_t val);
    /**
     * transmission mode
     */
    void transmit();
    ...
    bool setBandWidth(uint32_t bw)
    {
        if (bw != 12500 && bw != 25000) {
            Serial.printf("setBandWidth : %u failed!\n", bw);
            return false;
        }
        Serial.printf("setBandWidth : %u\n", bw);
        this->pdat.bandwidth = bw;
        return true;
    }
    ...
    bool enableLowPass(bool en);
    bool enableHighPass(bool en);
    bool enableEmpHassis(bool en);
